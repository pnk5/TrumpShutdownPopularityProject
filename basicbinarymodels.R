...
before_during_disapp_model <- lm(disapprove ~ period, before_during)
before_after_disapp_model <- lm(disapprove ~ period, before_after)
during_after_disapp_model <- lm(disapprove ~ period, during_after)